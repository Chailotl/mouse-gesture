...
function getGestureTranslations() {
	return {
		...
		'duplicateTab': getI18nMessage('duplicateTab', 'Duplicate Tab'),
...
function executeCustomGestureAction(action, gesture, resetGestureAfterAction) {
	switch (action) {
		...
		case 'forceRefresh':
			...
			break;
		case 'duplicateTab':
			safeSendMessage({ action: 'duplicateTab' });
			showGestureHint(getGestureTranslations().duplicateTab);
			resetGestureAfterAction();
			break;
		case 'closeTab':
				...
				if (actionKey) {
					...
					switch (customAction) {
						...
						case 'scrollRight':
							...
							break;
						case 'duplicateTab':
							actionText = getGestureTranslations().duplicateTab;
							break;
						case 'closeTab':
